...
public class Exercise1Test extends CompanyDomainForKata {
	...
	public void getCustomerNames() {
		...
		MutableList<String> expectedNames = FastList.newListWith("Fred", "Mary",
				"Bill");
    ...
    public void getCustomerCities()
    {
         ...
         */
        MutableList<Customer> customers = this.company.getCustomers();
        MutableList<String> customerCities = customers.collect(
        		new Function<Customer, String>() {
        			public String valueOf(Customer c) 
        			{
        				return c.getCity();
        			}
        		}
	...
	public void getLondonCustomers() {
		...
		MutableList<Customer> customersFromLondon = customers.select(
				new Predicate<Customer>() 
				{
					...
					{
						return c.getCity().equals("London");
					}
				});
